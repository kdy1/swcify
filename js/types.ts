...
/*
  Everything below here are the SWC option types (see https://github.com/swc-project/swc/blob/master/node-swc/src/types.ts).
  We have removed a few we don't care about (such as the JS plugin API as it is deprecated).
*/
